            ...
            <div class="col-md-12">
               <form class="form-horizontal" action="./util/joinUtil.jsp">
                  ...
                  <div class="form-group">
                     <label for="id" class="col-sm-2 col-sm-offset-1 control-label">아이디</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group">
                     <label for="name" class="col-sm-2 col-sm-offset-1 control-label">이름</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group">
                     <label for="업체명" class="col-sm-2 col-sm-offset-1 control-label">업체명</label>
                  ...
                  <div class="form-group">
                     <label for="inputEmail3"
                        class="col-sm-2 col-sm-offset-1 control-label">핸드폰번호</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group">
                     <label for="inputEmail3"
                        class="col-sm-2 col-sm-offset-1 control-label">내선번호</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group">
                     <label for="이메일" class="col-sm-2 col-sm-offset-1 control-label">이메일</label>
                     <div class="col-sm-8">
               ...
               <div class="icc">
                  <span class="input-content">가입 전 반드시 파인인사이트로 연락 주시기 바랍니다.<br>담당자를
                     통해 사용 승인해 드리겠습니다.<br>02-565-2920()
                  </span>
               </div>
               <div class="haha col-md-12">
                     <button class="btn-save sizeA" type="submit">회원가입</button>
                     <button class="btn-no sizeB" type="button" onclick="location.href='index.jsp' ">취소</button>
               </div>
