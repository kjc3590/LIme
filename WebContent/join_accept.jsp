						...
						<div class="yoho">
							...
							<nav>
								<ul class="pagination">
									...
									%>
									<li>
										<a href="join_accept.jsp?pageNum=<%=startPage - 1%>" aria-label="Previous"> 
									...
									%>
									<li>
										<a href="join_accept.jsp?pageNum=<%=i%>"><%=i%>
										 	<span class="sr-only">(current)</span>
										</a>
									</li>
									<%
									...
									%>
									<li>
										<a	href="join_accept.jsp?pageNum=<%=startPage + pageBlock%>"aria-label="Next"> 
