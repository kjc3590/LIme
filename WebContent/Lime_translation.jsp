						...
						<div class="table-responsive">
							...
							<form class="form-horizontal" name="update"
								...
								<div class="lazenca">
									<div class="totoyo">
										<p class="young0">
											<input class="btn-Lime btn" type="submit" value="저장">
										</p>
									</div>
								</div>
								...
								<table id="data-table-selection"
									...
									<thead>
										<tr class="tr-color">
											<th class="table-sort" style="border-left: 1px solid transparent;text-align: center;">*</th>
									...
									<tbody>
										...
										<tr class="tran warning">
											<td class="rowrow" rowspan="2" style="text-align: center;">
												...
												value="<%=resv.getTranslation_id()%>" name="id<%=ii%>" style="TEXT-ALIGN: CENTER;">
												<input type="hidden" value="<%=resv.getTranslation_id()%>"
												name="real_id">
											</td>
										...
										<tr class="tran warning">
											...
											<td><input type="text" class="form-control4"
												...
												name="trans_m_e<%=ii%>">
											<input type ="hidden" value="<%=resvList.size()%>" name ="ii">
